              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-[#0a0a0f]">
                  ...
                  <div className="absolute top-4 right-4 bg-[#0a0a0f]/80 backdrop-blur-md border border-[#1e293b] px-2.5 py-1.5 rounded flex items-center gap-1.5">
                    ...
                    <span className="text-xs font-bold text-white">{apt.rating}</span>
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <div className="flex items-center gap-2 text-[10px] font-bold tracking-widest text-[#64748b] uppercase mb-3">
                    ...
                    {apt.resort} <span className="text-[#1e293b]">/</span> {apt.location}
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#1e293b]">
                    <div>
                      <span className="font-black text-xl text-white tracking-tight">
                        ${apt.pricePerNight.toLocaleString('es-CL')}
                      </span>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow border-t border-[#1e293b]/50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[9px] font-bold tracking-widest text-[#64748b] uppercase">
                      TALLA: {eq.size || 'N/A'}
                    </span>
                  </div>
                  ...
                  <div className="mt-auto flex items-end justify-between">
                    <div>
                      <div className="text-[10px] text-[#64748b] font-bold tracking-widest uppercase mb-1">{eq.brand}</div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-sm font-bold tracking-widest uppercase mb-4 text-white">Verificación Técnica</h3>
              <p className="text-[#64748b] text-sm leading-relaxed font-medium">Inspeccionamos propiedades y triangulamos las compras en nuestra bodega física. Cero riesgo.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded bg-[#12121a] border border-[#1e293b] flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                <Package className="w-8 h-8 text-[#00d4ff]" />
              </div>
              <h3 className="text-sm font-bold tracking-widest uppercase mb-4 text-white">Red Privada</h3>
              <p className="text-[#64748b] text-sm leading-relaxed font-medium">Acceso exclusivo a inventario de alta gama. Solo usuarios verificados y reseñas de esquiadores reales.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded bg-[#12121a] border border-[#1e293b] flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                <Tag className="w-8 h-8 text-[#00d4ff]" />
              </div>
              <h3 className="text-sm font-bold tracking-widest uppercase mb-4 text-white">Eficiencia Directa</h3>
              <p className="text-[#64748b] text-sm leading-relaxed font-medium">Comisión plana y trato directo para asegurar las mejores tarifas del mercado premium.</p>
            </div>
          </div>
        </div>
      </section>
